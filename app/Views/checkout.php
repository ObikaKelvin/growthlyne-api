    ...
    <div class="container container__pad">
        <div class="checkout__hero hero">
            ...
            <div class="checkout__hero--right">
                <picture>
                    <source media="(min-width:1440px)" srcset="pictures/3-Device-Mashup.png">
                    <source media="(min-width:768px)" srcset="pictures/3-Device-Mashup.png">
                    <source media="(min-width:568px)" srcset="pictures/3-Device-Mashup.png">
                    <img class="checkout__hero--img" src="pictures/3-Device-Mashup.png" alt="hero-img" loading="lazy">
                </picture>
            </div>
        </div>
            ...
            <div class="checkout__flex--left">
                ...
                <div class="list checkout__list">
                    <div class="list__item list__item--checkout">
                        <object class="list__icon list__icon--checkout list__icon--md" data="/svg/Subtract.svg" type="image/svg+xml">
                        </object>
                ...
                <div class="checkout-testimonial">
                    ...
                    <div class="checkout-testimonial__card--container">
                        <div class="checkout-testimonial__card">
                            <div class="checkout-testimonial__card--left">
                                <img src="pictures/checkout-testimonial-user2.png" class="checkout-testimonial__img" alt="user" srcset="">
                            </div>
                    ...
                    <div class="checkout-testimonial__card--container">
                        <div class="checkout-testimonial__card">
                            <div class="checkout-testimonial__card--left">
                                <img src="pictures/checkout-testimonial-user.png" class="checkout-testimonial__img" alt="user" srcset="">
                            </div>
                            <div class="checkout-testimonial__card--right">
                ...
                <div class="card__guarantee">
                    ...
                    <div class="card__guarantee--container">
                        ...
                        <object class="card__guarantee--icon" data="/svg/NicePng_30-day-guarantee-png_3877949 1.svg" type="image/svg+xml"></object>
                    ...
                    <div class="card__guarantee--container">
                        <object class="card__guarantee--icon" data="/svg/NicePng_30-day-guarantee-png_3877949 2.svg" type="image/svg+xml"></object>
                    ...
                    <form action="" class="form__checkout">
                        <div class="card__payment">
                            ...
                            <div class="card__payment--top">
                                ...
                                <div class="form__row">
                                    ...
                                    <picture class="form__checkout--img">
                                        <source media="(min-width:1440px)" srcset="pictures/payment_method_discover_network_card-512.png">
                                        <source media="(min-width:768px)" srcset="pictures/payment_method_discover_network_card-512.png">
                                        <source media="(min-width:568px)" srcset="pictures/payment_method_discover_network_card-512.png">
                                        <img class="form__checkout--img" src="pictures/payment_method_discover_network_card-512.png" alt="marketer" loading="lazy">
                                    </picture>
                                </div>
                            ...
                            <div class="card__payment--middle">
                                ...
                                <div class="form__group--checkout">
                                    <label for="cardNo" class="form__checkout--label form__checkout--label__lg">Card Number</label>
                                    <input type="text" class="form__checkout--input" id="payPal" name="payment_method" placeholder="4242 4242 4242 4242">
                                </div>

                                <div class="form__group--checkout">
                                    <label for="cardNo" class="form__checkout--label form__checkout--label__lg">CVC Number</label>
                                    <input type="text" class="form__checkout--input" id="payPal" name="payment_method" placeholder="123">
                                </div>

                                <!-- <div class="form__group--checkout">
                                    <label for="cardNo" class="form__checkout--label form__checkout--label__lg">Expires</label>
                                    <div class="form__row form__row--checkout">
                                        <input type="text" class="form__checkout--input" id="payPal" name="payment_method" placeholder="">
                                        <input type="text" class="form__checkout--input" id="payPal" name="payment_method" placeholder="">
                                    </div>
                                </div> -->
                            ...
                            <div class="card__payment--bottom">
                                <div class="form__row form__row--checkout">
                                    ...
                                    <picture class="form__checkout--img">
                                        <source media="(min-width:1440px)" srcset="pictures/payment_method_discover_network_card-513.png">
                                        <source media="(min-width:768px)" srcset="pictures/payment_method_discover_network_card-513.png">
                                        <source media="(min-width:568px)" srcset="pictures/payment_method_discover_network_card-513.png">
                                        <img class="form__checkout--img" src="pictures/payment_method_discover_network_card-513.png" alt="marketer" loading="lazy">
                                    </picture>
                                </div>
                            </div>
